...
const SET_IS_CREATING_ACTION_TYPE_HEROES_REDUCER =
  "SET_IS_CREATING_ACTION_TYPE_HEROES_REDUCER";

const CREATE_NEW_HERO_ACTION_TYPE_HEROES_REDUCER =
  "CREATE_NEW_HERO_ACTION_TYPE_HEROES_REDUCER";

// ===== delete the hero =====
const DELETE_THE_HERO_ACTION_TYPE_HEROES_REDUCER =
  "DELETE_THE_HERO_ACTION_TYPE_HEROES_REDUCER";

//=====stats actions=====
const INCREASE_STRENGTH_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_STRENGTH_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_STRENGTH_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_STRENGTH_ACTION_TYPE_HEROES_REDUCER";

const INCREASE_AGILITY_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_AGILITY_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_AGILITY_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_AGILITY_ACTION_TYPE_HEROES_REDUCER";

const INCREASE_INTELLIGENCE_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_INTELLIGENCE_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_INTELLIGENCE_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_INTELLIGENCE_ACTION_TYPE_HEROES_REDUCER";

const INCREASE_CHARISMA_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_CHARISMA_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_CHARISMA_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_CHARISMA_ACTION_TYPE_HEROES_REDUCER";

//===== skills action =====
//===strength skills===
const INCREASE_ATTACK_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_ATTACK_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_ATTACK_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_ATTACK_ACTION_TYPE_HEROES_REDUCER";

//===agility skills===
const INCREASE_STEALTH_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_STEALTH_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_STEALTH_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_STEALTH_ACTION_TYPE_HEROES_REDUCER";

const INCREASE_ARCHERY_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_ARCHERY_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_ARCHERY_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_ARCHERY_ACTION_TYPE_HEROES_REDUCER";

//===intelligence skills===
const INCREASE_EDUCABILITY_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_EDUCABILITY_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_EDUCABILITY_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_EDUCABILITY_ACTION_TYPE_HEROES_REDUCER";

const INCREASE_SURVIVABILITY_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_SURVIVABILITY_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_SURVIVABILITY_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_SURVIVABILITY_ACTION_TYPE_HEROES_REDUCER";

const INCREASE_HEALING_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_HEALING_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_HEALING_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_HEALING_ACTION_TYPE_HEROES_REDUCER";

//=== charisma skills===
const INCREASE_INTIMIDATION_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_INTIMIDATION_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_INTIMIDATION_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_INTIMIDATION_ACTION_TYPE_HEROES_REDUCER";

const INCREASE_INSIGHT_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_INSIGHT_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_INSIGHT_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_INSIGHT_ACTION_TYPE_HEROES_REDUCER";

const INCREASE_APPEARANCE_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_APPEARANCE_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_APPEARANCE_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_APPEARANCE_ACTION_TYPE_HEROES_REDUCER";

const INCREASE_MANIPULATION_ACTION_TYPE_HEROES_REDUCER =
  "INCREASE_MANIPULATION_ACTION_TYPE_HEROES_REDUCER";
const DECREASE_MANIPULATION_ACTION_TYPE_HEROES_REDUCER =
  "DECREASE_MANIPULATION_ACTION_TYPE_HEROES_REDUCER";

//===== change character name =====
const CHANGE_NAME_ACTION_TYPE_HEROES_REDUCER =
  "CHANGE_NAME_ACTION_TYPE_HEROES_REDUCER";

// ===== set uploaded hero =====
const SET_UPLOADED_HERO_ACTION_TYPE_HEROES_REDUCER =
  "SET_UPLOADED_HERO_ACTION_TYPE_HEROES_REDUCER";
      ...
      return {
        ...
        heroes: [
          ...state.heroes,
          {
            ...
            id: state.heroes.length
              ? state.heroes[state.heroes.length - 1].id + 1
              : 1,
